...
public class ArrayTabulatedFunctionSerialization {
    public static void main(String[] args) {
        try (BufferedOutputStream outputStream = new BufferedOutputStream(new FileOutputStream("lr2/output/serialized array functions.html.bin"))) {
        ...
        try (BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream("lr2/output/serialized array functions.html.bin"))) {
